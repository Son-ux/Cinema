 ...
 * @author thanh
 */
public class GiaVeControll extends javax.swing.JDialog {

    /**
     * Creates new form GiaVe
     */
    public GiaVeControll(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GiaVeControll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GiaVeControll dialog = new GiaVeControll(new javax.swing.JFrame(), true);
